    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('quizzes.questions.store', $quiz) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div id="options-container" class="space-y-3">
                    <div class="option-row flex items-center space-x-3">
                        ...
                        <button type="button" class="remove-option text-red-600 hover:text-red-800 transition-colors" style="display: none;">
                ...
                <button type="button" id="add-option" class="mt-3 text-blue-600 hover:text-blue-800 text-sm font-medium transition-colors">
                    + Add another option
                </button>
            ...
            <div class="flex items-center justify-end space-x-3">
                <a href="{{ route('quizzes.questions.index', $quiz) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg font-medium transition-colors">
                    Cancel
                </a>
    ...
    addOptionBtn.addEventListener('click', function() {
        ...
        optionRow.innerHTML = `
            ...
            <input type="text" name="options[${optionCount}][text]" placeholder="Option ${optionCount + 1}" required
                class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            <button type="button" class="remove-option text-red-600 hover:text-red-800 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                </svg>
            </button>
