...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('quizzes.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
            Create Quiz
        </a>
    </div>
        ...
        <div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Questions</th>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Time Limit</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-700">{{ Str::limit($quiz->description, 50) }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="{{ route('quizzes.show', $quiz) }}" class="text-blue-600 hover:text-blue-800 transition-colors">View</a>
                                    <a href="{{ route('quizzes.edit', $quiz) }}" class="text-indigo-600 hover:text-indigo-800 transition-colors">Edit</a>
                                    <a href="{{ route('quizzes.questions.index', $quiz) }}" class="text-green-600 hover:text-green-800 transition-colors">Questions</a>
                                    <form action="{{ route('quizzes.toggle-publish', $quiz) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="text-yellow-600 hover:text-yellow-800 transition-colors">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Get started by creating a new quiz.</p>
                    <div class="mt-6">
                        <a href="{{ route('quizzes.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors">
                            Create Quiz
                        </a>
                    </div>
                </div>
